...
_ℹ️ - Grupo de desarrolladores oficial de este bot!_ */Legiao*
_ℹ️ - Si quieres saber sobre Íris o cómo construir "ela", use_ */About* .
_ℹ️ -_ *AVISO!* _Si algún comando no funciona significa que el servidor se ha bloqueado y es necesario esperar a que vuelva._

*0 - ${prefix}help (mensaje)*
_Informar errores a los responsables de Íris._

*1 - ${prefix}iris (mensaje)*
_Quiero hablar un poco?_

*2 - ${prefix}sticker*
_Haz que tus imágenes se conviertan en pegatinas rápidamente!_

*3 - ${prefix}gif*
_Con eso también puedes hacer pegatinas con gifs!_

*4 - ${prefix}donate*
_Ayúdame a comprar un "café" @.@_

*5 - ${prefix}speak <mensaje>*
...
*7 - ${prefix}dog*
_¿Amas a los cachorros?!_

*8 - ${prefix}ping*
_Bien, esto es para medir lo rápido que soy._

*9 - ${prefix}tts (sigla de idioma) [frase]*
_También puedo hacer mímica! Por voz!_

*10 - ${prefix}Idiomas*
_Esto es para usar con el comando superior._
...
*14 - ${prefix}waifu*
_Con eso les mando una foto de hermosas waifus._

*15 - ${prefix}neko*
_Bueno ... a veces un neko va bien bien?_
...
*18 - ${prefix}getmeme*
_¿Por qué no te gustan los memes??_
...
*1 - ${prefix}Clearall*
_Con eso todos los mensajes se borran._

*2 - ${prefix}Broad <-all/-gp> (mensage)*
_Puedo enviar un mensaje a todos o solo a los grupos que lo usan, pero cuidado con BAN (si hay muchos)._

*3 - ${prefix}Leaveall*
_Si quieres salir de todos los grupos._

*4 - ${prefix}Tela*
_Pídeme una serigrafía._

*5 - ${prefix}Blocklist*
_Averigua quién intentó llamarme, atacarme o inundarme._

*6 - ${prefix}mutepv <número sin + ou ->*
...
*9 - ${prefix}kickall*
_Quitar todos los miembros._

*10 - ${prefix}cmd <comando>*
_Ejecutar terminal/programación pelo WhatsApp._

*11 - ${prefix}block <numero> o <marcar un mensaje>*
_Bloquea a la gente._

*12 - ${prefix}unblock <numero> o <marcar un mensaje>*
_Desbloquea personas._

*13 - ${prefix}give <@Gente> <Cantidad>*
_Obtén o da XP a las personas y a ti mismo._`
}
...
_Comandos que solo admin pueden usar!_

*1 - ${prefix}kick @usuario o <Marcar un mensaje>*
_Expulsa a los borrachos del bar (puede ser más de 1)._

*2 - ${prefix}promote @user ou <Marque uma mensagem>*
_Hacer que los bebedores de bares se conviertan en gerentes._

*3 - ${prefix}leave*
_Si quieres puedo salir del bar._

*4 - ${prefix}demote @usuario o <Marcar un mensaje>*
_Esto es para que usted despida a los administradores del bar.._

*5 - ${prefix}everyone <assunto>*
_Marca a todos los borrachos por una mierda! ~Bromeando o no~_

*6 - ${prefix}del [Marque el mensaje del BOT]*
_Si necesita borrar mis mensajes, use este._

*7 - ${prefix}onlyadms [on|off]*
_Con eso cierro la barra solo para los administradores, y viceversa._

*8 - ${prefix}setimage*
_Dale a tu bot un nuevo aspecto!_

*9 - ${prefix}revoke*
_Si usa esto, restableceré el enlace._

*10 - ${prefix}Bomb <numero sin espacio, + e - >*
...
_Hace que deje de dar órdenes en el grupo de los que lo usaban._

*15 - ${prefix}unkick <Marcar un mensaje>*
_Deshacer una prohibición._

*16 - ${prefix}autosticker <on/off>*
_Haz pegatinas con todas las fotos que envían.._

*17 - ${prefix}welcome [enable|disable]*
_My te da la bienvenida y adiós._

*18 - ${prefix}rank <On/Off>*
_Activa el "RPG"._

*19 - ${prefix}softban @persona o <Marcar un mensaje>*
_Prohibir al usuario y agregarlo nuevamente en 30 minutos._

*20 - ${prefix}add (numero)*
_Con eso puedes agregar personas._`
}
...
Si no entiende, llame a mi dueño, use el comando ${prefix}criador o pide en el grupo que alguien definitivamente te ayude! XD

Gracias por usar!

Programador oficial desse BOT: wa.me/524444444413`
}

exports.donate = donate()
function donate() {
    return `
_No es necesario, pero si quieres contribuir, el yappy del creador de este bot es =_

+507 6467-5192

_O seguirme en instagram =_ 

@ssanchez.pty

_Si es necesario, ven y habla conmigo en github en =_ github.com/carlos177118/carlitoV3-bot _o por WhatsApp_ wa.me/+524444444413.
❤️`
}
...
function lang() {
    return `
☾ Idiomas de los comandos de voz ☽
       ☾ Use sem ' ' ☽
...
exports.convh = convh()
function convh() {
	return `_Para usar debes escribir_ *${prefix}conv [-sigla] [Número para convertir]* _, compruebe los acrónimos a continuación y un ejemplo._
	
*-h* _= Ese menú._

*-c* _= Convertir de Fahrenheit a Celsius._

*-f* _= Convertidor Celsius a Fahrenheit._

*-q* _= Convertir millas a kilómetros._

*-m* _= Convertir Kilómetros en Millas._
...
function paises() {
	return `_Nombres aceptados por el comando_ *${prefix}covid*\n\nAfghanistan\n\nAlbania\n\nAlgeria\n\nAndorra\n\nAngola\n\nAnguilla\n\nAntigua and Barbuda\n\nArgentina\n\nArmenia\n\nAruba\n\nAustralia\n\nAustria\n\nAzerbaijan\n\nBahamas\n\nBahrain\n\nBangladesh\n\nBarbados\n\nBelarus\n\nBelgium\n\nBelize\n\nBenin\n\nBermuda\n\nBhutan\n\nBolivia\n\nBosnia and Herzegovina\n\nBotswana\n\nBrazil\n\nBritish Virgin Islands\n\nBrunei\n\nBulgaria\n\nBurkina Faso\n\nBurundi\n\nCAR\n\nCabo Verde\n\nCambodia\n\nCameroon\n\nCanada\n\nCaribbean Netherlands\n\nCayman Islands\n\nChad\n\nChannel Islands\n\nChile\n\nChina\n\nColombia\n\nComoros\n\nCongo\n\nCosta Rica\n\nCroatia\n\nCuba\n\nCuraçao\n\nCyprus\n\nCzechia\n\nDRC\n\nDenmark\n\nDiamond Princess\n\nDjibouti\n\nDominica\n\nDominican Republic\n\nEcuador\n\nEgypt\n\nEl Salvador\n\nEquatorial Guinea\n\nEritrea\n\nEstonia\n\nEswatini\n\nEthiopia\n\nFaeroe Islands\n\nFalkland Islands\n\nFiji\n\nFinland\n\nFrance\n\nFrench Guiana\n\nFrench Polynesia\n\nGabon\n\nGambia\n\nGeorgia\n\nGermany\n\nGhana\n\nGibraltar\n\nGreece\n\nGreenland\n\nGrenada\n\nGuadeloupe\n\nGuatemala\n\nGuinea-Bissau\n\nGuinea\n\nGuyana\n\nHaiti\n\nHonduras\n\nHong Kong\n\nHungary\n\nIceland\n\nIndia\n\nIndonesia\n\nIran\n\nIraq\n\nIreland\n\nIsle of Man\n\nIsrael\n\nItaly\n\nIvory Coast\n\nJamaica\n\nJapan\n\nJordan\n\nKazakhstan\n\nKenya\n\nKuwait\n\nKyrgyzstan\n\nLaos\n\nLatvia\n\nLebanon\n\nLesotho\n\nLiberia\n\nLibya\n\nLiechtenstein\n\nLithuania\n\nLuxembourg\n\nMS Zaandam\n\nMacao\n\nMadagascar\n\nMalawi\n\nMalaysia\n\nMaldives\n\nMali\n\nMalta\n\nMarshall Islands\n\nMartinique\n\nMauritania\n\nMauritius\n\nMayotte\n\nMexico\n\nMicronesia\n\nMoldova\n\nMonaco\n\nMongolia\n\nMontenegro\n\nMontserrat\n\nMorocco\n\nMozambique\n\nMyanmar\n\nNamibia\n\nNepal\n\nNetherlands\n\nNew Caledonia\n\nNew Zealand\n\nNicaragua\n\nNiger\n\nNigeria\n\nNorth Macedonia\n\nNorway\n\nOman\n\nPakistan\n\nPalestine\n\nPanama\n\nPapua New Guinea\n\nParaguay\n\nPeru\n\nPhilippines\n\nPoland\n\nPortugal\n\nQatar\n\nRomania\n\nRussia\n\nRwanda\n\nRéunion\n\nS. Korea\n\nSaint Kitts and Nevis\n\nSaint Lucia\n\nSaint Martin\n\nSaint Pierre Miquelon\n\nSamoa\n\nSan Marino\n\nSao Tome and Principe\n\nSaudi Arabia\n\nSenegal\n\nSerbia\n\nSeychelles\n\nSierra Leone\n\nSingapore\n\nSint Maarten\n\nSlovakia\n\nSlovenia\n\nSolomon Islands\n\nSomalia\n\nSouth Africa\n\nSouth Sudan\n\nSpain\n\nSri Lanka\n\nSt. Barth\n\nSt. Vincent Grenadines\n\nSudan\n\nSuriname\n\nSweden\n\nSwitzerland\n\nSyria\n\nTaiwan\n\nTajikistan\n\nTanzania\n\nThailand\n\nTimor-Leste\n\nTogo\n\nTrinidad and Tobago\n\nTunisia\n\nTurkey\n\nTurks and Caicos\n\nUAE\n\nUK\n\nUSA\n\nUganda\n\nUkraine\n\nUruguay\n\nUzbekistan\n\nVanuatu\n\nVatican City\n\nVenezuela\n\nVietnam\n\nWallis and Futuna\n\nWestern Sahara\n\nWorld\n\nYemen\n\nZambia\n\nZimbabwe`
}
